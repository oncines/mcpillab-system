...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Attendance Approval</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="content-card">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-0">Attendance Approval</h2>
                            <p class="text-muted mb-0">Review and approve employee attendance with photo verification</p>
                        </div>
                        <div class="user-info">
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="stats-card">
                            <div class="stats-number"><?php echo count($pending_attendance); ?></div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-card">
                            <div class="stats-number">
                                <?php 
                                $today_count = array_filter($pending_attendance, function($att) {
                                    return date('Y-m-d', strtotime($att['created_at'])) == date('Y-m-d');
                                });
                        ...
                        <?php foreach ($unread_notifications as $notification): ?>
                            <div class="notification-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <strong><?php echo $notification['first_name'] . ' ' . $notification['last_name']; ?></strong>
                                    ...
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <button type="submit" name="approve_attendance" class="btn btn-sm btn-approve">
